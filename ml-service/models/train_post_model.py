...
# Generate synthetic post-transplant data
np.random.seed(99)
n = 100
df = pd.DataFrame({
...
# Define post_status_ok as label = 1 if stable and recovering
df["label"] = (
    (df["recovery_score"] > 0.6) &
...
dump(ensemble, "models/post_transplant_model.joblib")
print("✅ Post-transplant model trained and saved.")
